@echo off
chcp 65001 >nul
title Build Portable - Koda Cut v0.3
cd /d "%~dp0"
...
jpackage --type app-image --dest dist --name "Koda Cut" --input build --main-jar KodaCut.jar --main-class kodacut.KodaCut --vendor "Koda" --app-version 0.3 --icon assets\koda-cut.ico
if errorlevel 1 goto :erro
